...
from baximanderSim import runSimulator
from gm_Simulator import f_leg_act
import sys
from pprint import pprint

def initPramsVector(numParams = 11):
    '''
...
def normalizePi(oriPi, scaler):
    # Range = [dutyf, interPhi, meterPhi, outerPhi, c1, a2_1, a2_2, c2, b2_1, b2_1 c3, c4]
...
def policyGradientTrain(t, episodes, epsilon, selfInit = False, object = 'Displacement', stepSize = 2., paramScaler = 7):
    ...
    for episode in range(episodes):
        ...
        sio.savemat('RL_results_randominit.mat', {'parameters': savePi, 'results': saveResults})
...
def selfInitParams():
    ...
    b3 = 4.36691547831
    '''
    a2_1 = 0.825796303018#random.uniform(0, math.pi / 3.)
